...
# 获得商品的操作数
def get_sku_fea_in_action(starttime, endtime,action_data):
    ActionData=action_data[(action_data['time']>=starttime)&(action_data['time']<=endtime)]
...
def cal_buy_attention_pro(starttime, endtime,action_data):
    ActionData=action_data[(action_data['time']>=starttime)&(action_data['time']<=endtime)]
...
def cal_buy_click_pro(starttime, endtime,action_data):
    ActionData=action_data[(action_data['time']>=starttime)&(action_data['time']<=endtime)]
...
def cal_buy_view_pro(starttime, endtime,action_data):
    ActionData=action_data[(action_data['time']>=starttime)&(action_data['time']<=endtime)]
...
def cal_buy_addcart_pro(starttime, endtime,action_data):
    ActionData=action_data[(action_data['time']>=starttime)&(action_data['time']<=endtime)]
...
def cal_convert_buy_pro(starttime, endtime,action_data):
    buy_attention_pro =  cal_buy_attention_pro(starttime, endtime,action_data)
    buy_click_pro = cal_buy_click_pro(starttime, endtime,action_data)
    buy_view_pro = cal_buy_view_pro(starttime, endtime,action_data)
    buy_addcart_pro = cal_buy_addcart_pro(starttime, endtime,action_data)
...
def gen_sku_fea(starttime, endtime,action_data):

    sku_basic_fea = get_basic_product_fea()
    sku_fea_in_comment = get_comment_product_fea(endtime)
    sku_fea_in_action = get_sku_fea_in_action(starttime, endtime,action_data)
    convert_buy_pro = cal_convert_buy_pro(starttime, endtime,action_data)
    ...
    # sku_fea_in_action_global = get_sku_fea_in_action(global_start_time, endtime,action_data)
    # convert_buy_pro_global = cal_convert_buy_pro(global_start_time, endtime,action_data)
